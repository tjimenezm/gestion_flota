...
public class VehiculoRepository {
	...
	public List<Vehiculo> getAllVehiculos() {
		...
		rows.forEach(row -> {
			...
			vehiculo.setFechaRevisionTecnica((LocalDateTime)row.get("fecha_revision_tecnica"));
			...
			vehiculo.setFechaPoliza((LocalDateTime)row.get("fecha_poliza"));
			vehiculo.setFechaIngreso((LocalDateTime)row.get("fecha_ingreso"));
			vehiculo.setFechaBaja((LocalDateTime)row.get("fecha_baja"));
